  ...
  switch (swap_status) {
    ...
    case "under_dispute":
      return {
        ...
        desc: "This protected swap is under dispute. Wait for support decision.",
        className:
  ...
  switch (sale_status) {
    case "awaiting_buyer_payment":
      return {
        ...
        desc: "Buyer must complete payment before you ship.",
        className:
          "bg-amber-100 text-amber-800 dark:bg-amber-900/60 dark:text-amber-200",
      };
    case "buyer_paid":
      return {
        ...
        desc: "You should ship the gift now.",
        className:
    ...
    case "shipped":
      return {
        label: "Shipped",
        desc: "You marked this gift as shipped.",
        className:
          "bg-blue-100 text-blue-800 dark:bg-blue-900/60 dark:text-blue-200",
      };
    case "sale_completed":
      return {
        ...
        desc: "Buyer confirmed delivery. Sale is finished.",
        className:
    ...
    case "under_dispute":
      return {
        label: "Under dispute",
        desc: "Buyer opened a dispute. Support is reviewing this sale.",
        className:
          "bg-red-100 text-red-800 dark:bg-red-900/60 dark:text-red-200",
      };
    case "refunded":
      return {
        ...
        desc: "Dispute resolved: buyer has been refunded for this sale.",
        className:
...
const OffersReceived = () => {
  ...
  const [selectedGiftRole, setSelectedGiftRole] = useState(null); // "your_gift" | "offered"
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {offers.map((offer) => {
              ...
              return (
                ...
                >
                  {/* الصف العلوي: صورة هديتك + العنوان */}
                  <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                    <button
                      type="button"
                      onClick={() =>
                        setSelectedGift(() => {
                          setSelectedGiftRole("your_gift");
                          return {
                            title: offer.gift_title || "Your gift",
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 mt-1 capitalize text-sm">
                      ...
                      <p className="mt-2 text-gray-800 dark:text-gray-100 text-sm">
                  ...
                  {/* كرت الهدية التي يعرضها المرسل في التبادل */}
                  {!isBuyOffer && (
                    <button
                      type="button"
                      onClick={() =>
                        setSelectedGift(() => {
                          ...
                          if (offer.swap_gift_id && offer.swap_gift_title) {
                            return {
                              ...
                              description:
                                "This is the gift they want to swap with yours.",
                    ...
                    >
                      ...
                      {offer.swap_gift_id && offer.swap_gift_title ? (
                        ...
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          (No image provided for the swap gift.)
                        </p>
                      )}
                    </button>
                  )}
            ...
            <div className="p-5 sm:p-6 border-b border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-2">
                  {selectedGiftRole === "your_gift"
                    ? "This is your gift in this offer."
                    : "This is the gift the other user offers in exchange."}
                </p>
              </div>
            </div>
